...
exports.updateAboutBanner = exports.getAboutPage = exports.addOrUpdateAboutPage = exports.getHomeBanner = exports.getHomeBannersOption1 = exports.deleteHomeBannerOption1 = exports.addHomeBannerOption1 = exports.deleteProduct = exports.getProductsByCategory = exports.getAllProducts = exports.productAdd = void 0;
...
const addHomeBannerOption1 = async (req, res) => {
    try {
        ...
        if (!homePage) {
            ...
            const updateData = position === "1" ? { banner1: bannerUrl } : { banner2: bannerUrl };
...
exports.addHomeBannerOption1 = addHomeBannerOption1;
const deleteHomeBannerOption1 = async (req, res) => {
    try {
...
exports.deleteHomeBannerOption1 = deleteHomeBannerOption1;
const getHomeBannersOption1 = async (req, res) => {
    try {
        const homePage = await prisma.homePage.findFirst();
        if (!homePage) {
            res.status(404).json({ msg: "HomePage not found" });
...
exports.getHomeBannersOption1 = getHomeBannersOption1;
...
// AboutPage APIs
const addOrUpdateAboutPage = async (req, res) => {
    try {
        const { title, description1, description2, description3, whatWeDoTitle, whatWeDoDescription1, whatWeDoDescription2, } = req.body;
        const file = req.file;
        if (!file ||
            !title ||
            !description1 ||
...
exports.addOrUpdateAboutPage = addOrUpdateAboutPage;
...
exports.updateAboutBanner = updateAboutBanner;
