...
const Services: React.FC = () => {
  const services: ServiceItem[] = [
    ...
    },
    {
      ...
      description:
        "We offer a range of in-house jewelry plating services to enhance both the beauty and durability of your pieces. Choose from our various options including yellow gold flash, rose gold flash, yellow vermeil, and rose vermeil. Additionally, we provide black ruthenium for a modern edge, white rhodium for a bright, reflective finish, as well as E-coating and anti-tarnish coating to protect and preserve your jewelry.",
      image: platingImg,
    },
  ];
  ...
  const finishes: FinishItem[] = [
    ...
    },
    {
      title: "Satin Finish",
      description:
        "Creates a smooth, velvety appearance with a soft luster that strikes a perfect balance between matte and high polish.",
    },
    {
      title: "Hammered Finish",
      description:
        "Features textured indentations that catch and reflect light in unique ways, adding character and dimension to your jewelry pieces.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Incorporates darkened recesses that highlight the details of intricate designs, giving pieces a vintage, timeworn appeal.",
    },
  ];
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-gray-700">
              At NAVKAR DESIGNS, INDIA, we excel in transforming your jewelry
              visions into reality with our extensive range of high-quality
              manufacturing services. Situated in the heart of Jaipur,
              Rajasthan, our expertise spans across various types of jewelry and
              processing techniques to ensure every piece is crafted to
              perfection.
            </motion.p>
          </motion.div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:ltr" : ""}>
                  ...
                  <div className="w-20 h-px bg-gold mb-6"></div>
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-gray-700">
              ...
              create the perfect aesthetic for your jewelry pieces.
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {finishes.map((finish, index) => (
              ...
              >
                <h3 className="text-xl font-playfair mb-4">{finish.title}</h3>
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gold p-12 md:p-16 rounded-lg text-center"
          >
            <h2 className="text-2xl md:text-3xl font-playfair mb-4 text-gray-900">
            ...
            <p className="text-gray-900 max-w-2xl mx-auto mb-8">
              ...
              of experts is ready to bring your jewelry dreams to life.
            </p>
            <a
              href="/contact"
              className="inline-block px-8 py-3 bg-gray-900 text-white font-medium hover:bg-gray-800 transition-colors rounded-md"
            >
              Get in Touch
            </a>
          </motion.div>
